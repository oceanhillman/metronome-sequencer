...
const Pattern = forwardRef((props, ref) => {
    ...
    // Add a check to ensure patternData is defined and provide default values
    ...
    const [inputData, setInputData] = useState({
        ...
        beatsPerMeasure: initialData.beatsPerMeasure,
        bpm: initialData.bpm,
        numMeasures: initialData.numMeasures,
    });
    ...
    useEffect(() => {
        if (patternData) {
            ...
            handleUpdate('duration', handleUpdate('duration', newDuration));
        }
    }, [patternData?.numMeasures, patternData?.beatsPerMeasure, patternData?.bpm]);
    ...
    function Buttons() {
        if (!performing) {
            return (
                <div className="flex h-[24px] items-center space-x-1">
