...
const Playlist = ({ song, addToHistory, handleUpdatePlaylist, handleUpdateLayout, handleUpdatePattern, handleClickDelete, handleClone, currentPatternId, performing, startFromPattern, isPlaying }) => {
