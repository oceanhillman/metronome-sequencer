...
import { isSubscribed, checkout } from '@lib/api';
            ...
            <section className="bg-eerie-black">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-4">
                    ...
                    <div className="bg-tuna p-4 border-1 border-persian-pink shadow">
                        ...
                        <button onClick={() => checkout(user, '/get-pro/redirect')} className="w-full mt-4 xl:mt-0 inline-flex items-center justify-center px-5 py-3 shadow text-base no-underline font-medium text-center text-persian-pink border-1 border-persian-pink hover:bg-cultured/5 focus:ring-4 focus:ring-gray-100">
                            Subscribe
                        </button> 
